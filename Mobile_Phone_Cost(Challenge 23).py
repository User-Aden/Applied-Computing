...
c = float(input("How much data would you like to use this month (they cost $0.05 for 1 MB): "))
#Pause for 0.5 seconds
time.sleep(0.5)
#Calculate the cost of every price: times the amount of picutres, texts, and data by their espective prices
pic = x * 0.35
text = d * 0.10
data = c * 0.05
...
print ("\nThe total cost of your phone bills this month comes to $" + str(bill))
#Pause for 0.5 seconds
time.sleep(0.75)
